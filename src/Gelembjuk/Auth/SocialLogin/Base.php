...
abstract class Base {
	...
	*/
	...
	/**
	 * Load user profile by token ID, provided by some other API client.
	 * This can be used for getting a provier from token ID created on android integration
	 * 
	 * @param string $tokenid String generated by other AP client
	 */
	abstract public function loginWithTokenID($tokenid);
